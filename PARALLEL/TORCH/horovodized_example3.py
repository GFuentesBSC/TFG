...
train_loader = DataLoader(dataset=train_dataset, batch_size=16, sampler=hvd_sampler_train_loader)
...
val_loader = DataLoader(dataset=val_dataset, batch_size=20, sampler=hvd_sampler_val_loader)
